...
class Args:
    def __init__(self, config_path=None):
        ...
        self.seed = 123
        self.device = 'cuda:0' # cpu for rendering
        ...
        #Render
        self.render = False
        self.load_model_path = "example_path/adversary_seed123456_model"
        self.load_model_name = "adversary_seed123456"
        

    def set_save_paths(self, env_name = "mpe_fluid"): 
        # save path
        self.env_name = env_name
        self.save_path = f'./result/sacred/acorm/{self.env_name}/{self.env_name}_seed{self.seed}'
        self.model_path = f'./result/model/acorm/{self.env_name}/{self.env_name}_seed{self.seed}'
...
if __name__ == '__main__':
    ...
    env = "adversary"
    args = Args(config_path=f'./config/envs/{env}_mpev2.yaml')
