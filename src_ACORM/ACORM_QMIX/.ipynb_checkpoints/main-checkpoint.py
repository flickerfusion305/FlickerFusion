...
class Args:
    def __init__(self, config_path=None):
        ...
        # save path
        self.save_path = f'./result/acorm/{self.env_name}'
        self.model_path = f'./model/acorm/{self.env_name}'
    ...
    def print_args(self):
        """
        Prints all attributes of the Args instance with their names and values.
        """
        print("Arguments:")
...
if __name__ == '__main__':
    args = Args(config_path='config/envs/adversary_mpev2.yaml')
    torch.multiprocessing.set_start_method('spawn')
    runner = Runner(args)
    runner.run()
