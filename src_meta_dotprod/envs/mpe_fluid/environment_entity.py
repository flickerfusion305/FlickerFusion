...
class MultiAgentFluidEnv(gym.Env, MultiAgentEnv):
    ...
    def reset(self, constrain_num=None, test=False, index=None, domain_n = 0, meta_lr_scheme=None, domain_type=None):
        # reset world
        self.reset_callback(self.world, np_random = np.random , test=test, domain_n=domain_n, meta_lr_scheme=meta_lr_scheme, domain_type=domain_type)
        # reset renderer
        self._reset_render()
