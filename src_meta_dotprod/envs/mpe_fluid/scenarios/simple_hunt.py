...
class Scenario(BaseScenario):
    ...
    def random_initial_world(self, world, np_random, agent_config, adversary_config, domain_type):
        domain_type += 1
        agent_start, agent_end = agent_config
        adv_start, adv_end = adversary_config
        ...
        if 1 <= domain_type <= 3:
            ...
            if domain_type == 1:
                adv_initial_num = possible_adv_list[0]
            elif domain_type == 2:
                adv_initial_num = possible_adv_list[1]
            else:
                adv_initial_num = possible_adv_list[2]
        ...
        for i in range(adv_initial_num):
            agent = Agent()
            agent.adversary = True
            agent.name = f"adv_{world.adv_count}" 
            agent.collide = True
        ...
        return agent_initial_num, adv_initial_num
