...
def run(_run, _config, _log):
    ...
    unique_token += "{}_{}".format(args.name, args.env_args['scenario_id'][7:-3])
    ...
    str(args.rnn_hidden_dim), str(args.rnn_input_dim), datetime.datetime.now().strftime("%m%d_%H%M%S_%f")
)
