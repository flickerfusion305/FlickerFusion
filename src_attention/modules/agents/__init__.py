...
from .rnn_skip_agent import RNNSkipAgent
from .ff_agent import FFAgent
from .sw_ff_agent import SlidingFFAgent
from .entity_rnn_agent import ImagineEntityAttentionRNNAgent, EntityAttentionRNNAgent
from .entity_swmlp_agent import EntityAttentionSWAgent
...
REGISTRY["rnn_skip"] = RNNSkipAgent
REGISTRY["ff"] = FFAgent
REGISTRY["sliding_window"] = SlidingFFAgent
REGISTRY["entity_attend_SW"] = EntityAttentionSWAgent
